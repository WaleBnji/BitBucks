...
const Crypto = () => {
  ...
  const { fetchData: allCoins } = useContext(CryptoContext);
  console.log(allCoins);
  ...
  return (
    <div>
      <div className='space-y-4 flex flex-col justify-start lg:flex-row lg:justify-between'>
            ...
            allCoins2?.data.map((coin, index) => {
              return (
                <tr className='border-b text-center ' key={index}>
                  ...
                  <td className='py-1 font-semibold'>Bitcoin</td>
